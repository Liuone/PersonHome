...
<head>
    ...
    <meta content="" name="description" charset="UTF-8" />
    ...
    <div class="login"  id="main_login" >
        ...
        <div class="input_text" >
            ...
            <form  id = "myform" >
                ...
                <div >
                     <button type="buttion" id="login-submit-btn" class="layui-btn  btn-login"  style="width:150px" onclick="login()" >&nbsp;&nbsp;登　录&nbsp;&nbsp;</button>
